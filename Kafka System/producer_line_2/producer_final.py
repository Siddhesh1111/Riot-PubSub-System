...
player_list = ["TSM FTX WARDELL"]
player_list_channel = ['UCYg5NWc3B8RuarSFQR8n2VA']
random_number = 100
...
def get_producer_obj():
    ...
    while(True):
        try:
            print('-------------------INSIDE-----------------')
            producer = KafkaProducer(bootstrap_servers='kafka1:19092',value_serializer=json_serializer)
            print(producer)
            return producer
...
def scrape_players():
    ...
    for player in player_list:
        ...
        # channel_id.append('UCYg5NWc3B8RuarSFQR8n2VA')
        # index_ = index_ + 1
...
def scraper_main(producer_obj):
    ...
    while(flag == 0):
        ...
        for update in updates:
            producer_obj.send('UCYg5NWc3B8RuarSFQR8n2VA',update)
        time.sleep(21600)
