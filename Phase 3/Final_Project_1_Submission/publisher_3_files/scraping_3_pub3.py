...
url = 'http://central_broker_3:5005/publish'
player_list = ["ShahZaM","ScreaM","AverageJonas"]
player_list_channel = ['UCKNq_4ub5GACIkQfuVWEBtg', 'UCOpuMFmU3RyTeXejHWldXkA', 'UCg7fw-hJTvJBie_2T6l1dGg']
flag =0
random_number = 200
...
def scraper_main():
    ...
    while(flag == 0):
        try:
            ...
            message = r.json()
            if message['message']=='Hello pub3':                               #Start collecting data after successful comms with broker
                print("client hi")
