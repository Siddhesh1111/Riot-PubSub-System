...
url = 'http://central_broker_3:5005/new_sub'
url_2 = 'http://central_broker_3:5005/add_sub'
url_3 = 'http://central_broker_3:5005/unsubscribe_user'
...
def login():
    if request.method == "POST":
        ...
        if "login_client_3" not in list_of_db:
            
            db = conn["login_client_3"]
...
def notify_user():
    ...
    if request.method == "POST":
        if user_name in session_client_1.keys(): 
            ...
            print('*************************Inside client 2 notify***************',message_from_broker)
