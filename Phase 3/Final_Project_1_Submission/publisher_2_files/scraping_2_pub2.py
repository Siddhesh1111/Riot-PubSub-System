...
url = 'http://central_broker_2:5003/publish'
player_list = ["100T Hiko","SEN Sinatraa","SEN Sick"]
player_list_channel = ['UCRN1XC7PnnTL5R_GbYOMCZg', 'UCABUGfcFJhffRFZxSl-mIiw', 'UCc8Er6GHj0casXQC9kOz-Ug']
flag =0
random_number = 100
...
def get_conn():
    ...
    if "publisher_2_data" not in list_of_db:
...
def scraper_main():
    ...
    while(flag == 0):
        try:
            ...
            message = r.json()
            if message['message']=='Hello pub2':                               #Start collecting data after successful comms with broker
                print("client hi")
