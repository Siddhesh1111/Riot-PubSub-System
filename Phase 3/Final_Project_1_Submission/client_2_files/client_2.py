...
url = 'http://central_broker_2:5003/new_sub'
url_2 = 'http://central_broker_2:5003/add_sub'
url_3 = 'http://central_broker_2:5003/unsubscribe_user'
...
def login():
    if request.method == "POST":
        ...
        if "login_client_2" not in list_of_db:
            
            db = conn["login_client_2"]
...
def notify_user():
    ...
    if request.method == "POST":
        if user_name in session_client_1.keys(): 
            ...
            print('*************************Inside client 2 notify***************',message)
